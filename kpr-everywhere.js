...
//------------------------------------------------------------
var styles = s6.defaultStyles;
for (var selector in styles) {
   s6.css(selector, styles[selector]);
}
...
//s6.attach(s6, 'ready', function() {
   ...
   s6.attach(document, 'touchstart', touchHandler);
   s6.attach(document, 'touchmove', touchHandler);
   s6.attach(document, 'touchend', touchHandler);
   s6.attach(document, 'touchcancel', touchHandler);
   s6.attach(window, 'orientationchange', orientationChangeHandler);

   function orientationChangeHandler(e) {
       presentation.style.width = "100%";
       if (window.orientation == 0) {
           presentation.style.height = "1372px";
       } else {
           presentation.style.height = "580px";
       }
